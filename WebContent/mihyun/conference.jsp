...
<body>
 <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#282828;">
            ...
            <a class="navbar-brand" href="./conference.jsp" style=" width:55%; font-size:25px; padding-top:12px; text-align: left;" >Conference Schedule</a>
      </nav>
      <div>
      <a class="navbar-brand" href="javascript:history.back();"><i class="fas fa-arrow-left" style="width:50px; height:50px; float:left;"></i></a>
      <a class="navbar-brand" href="../home/main.jsp"><i class="fas fa-home" style="width:50px; height:50px; float:left;"></i></a>
      </div>
    <div class="container">
<!-- 일정추가전 생기는 카탈로그 창 -->
        <!-- 일자 클릭시 메뉴오픈 -->
