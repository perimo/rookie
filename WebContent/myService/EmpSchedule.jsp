...
<body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#282828;">
            <a class="navbar-brand" href="../main/main.jsp" style="width:45%;  font-size:25px; padding-top:12px;  text-align: left;" >2RP PROGRAM</a>
      ...
      <a class="navbar-brand" href="../main/main.jsp"><i class="fas fa-home" style="width:50px; height:50px; float:right;"></i></a>
      </div>
...
<!-- </div>
    ...
    <script src="../mihyun_cal/js/EmpMain.js"></script>
    <script src="../mihyun_cal/js/EmpAddEvent.js"></script>
    <script src="../mihyun_cal/js/EmpEditEvent.js"></script>
    <script src="../mihyun_cal/js/EmpEtcSetting.js"></script>
</body>
</html>