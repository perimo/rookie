...
<!-- 	<!-- 이전꺼 보여주는 거 
   ...
   <div id="page_contents" style="border: 1px solid yellow; margin: 10px 10px;">
	<div class="toolbar">
  		<button id="restore" class="btn btn-success"data-dismiss="modal">확인</button>
  		<button id="delete" class="btn btn-danger"data-dismiss="modal">취소</button>
	</div>
  		 <!-- ========================= 휴지통 테이블 ========================== -->
		<table id="table" 
			...
			<thead>
				<tr>
					...
					<th data-field="app_no" data-sortable="true" data-align="center" data-width="10">사 원 번 호</th>
					<th data-field="app_name" data-sortable="true">사 원 이 름</th>
					<th data-field="app_write" data-sortable="true">사 원 부 서</th>
					<th data-field="app_print" data-align="center"data-sortable="true">직 급</th>
				</tr>
			</thead>
		</table><!-- ======================== 휴지통 테이블 끝 ====================== -->
	</div>
