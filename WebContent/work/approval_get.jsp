		...
		<div id="layoutSidenav_content">
			<main id="input_div">
				<div id="frame_div" style="border: 1px solid black;">
					<div id="page_title"
						style="border: 1px solid red; margin: 10px 30px;">
						<h2>결재신청</h2>
					</div>
					<div id="page_contents"
						style="max-width: 1730px; border: 1px solid yellow; margin: 50px 50px;">
						<!-- 컨텐츠 들어갈내용 시작-->
						...
						<div class="row">
							...
							<div style="margin-top: 15px;" class="col-5">
								...
								<button style="margin-right: 5px;"
									class="btn btn-primary btn-lg" data-toggle="modal"
									data-target="#myModal1">기각</button>

								<!-- 드랍다운 -->
								<button class="btn btn-primary btn-lg dropdown-toggle"
									type="button" id="dropdownMenuButton" data-toggle="dropdown"
									aria-haspopup="true" aria-expanded="false">이동</button>
