		...
		<div id="layoutSidenav_content">
			<main id="input_div">
				<div id="frame_div" style="border: 1px solid black;">
					...
					<div id="page_contents" style="border: 1px solid yellow; margin: 50px 110px; padding: 0px 50px;" >
						<!-- 컨텐츠 들어갈내용 시작-->
						...
						<div class="row">
							<div class="col-sm-6">
								<table class="table table-boardered">
									<tr>
										<th>사원번호</th>
										<td><input id="empNo" type="text" class="form-control" name="empNo" placeholder="사원번호를 입력하세요." disabled></td>
									</tr>
									<tr>
										<th>사원명</th>
										<td><input id="empName" type="text" class="form-control" name="empName" disabled></td>
									</tr>
									<tr>
										<th>패스워드</th>
										<td><input id="empPw" type="password" class="form-control" name="empPw" disabled></td>
										<td>
									...
									<tr>
										<th>주민번호</th>
										<td><input id="empJumin" type="text" class="form-control" name="empJumin" disabled></td>
									</tr>
									<tr>
										<th>사진</th>
									...
									<tr>
										<th>부서명</th>
										<td>
											<select id="deptName" name="deptName" class="form-control" disabled>
									...
									<tr>
										<th>부서번호</th>
										<td><input id="deptNo" type="text" class="form-control" name="deptNo" disabled></td>
									</tr>
								</table>
							</div>
							...
							<div class="col-sm-6">
								<table class="table table-boardered">
									<tr>
										<th>내선번호</th>
										<td><input id="deptTel" type="tel" class="form-control" name="deptTel" disabled></td>
									</tr>
									<tr>
										<th>직급</th>
										<td><input id="empLevel" type="text" class="form-control" name="empLevel" disabled></td>
									</tr>
									<tr>
										<th>연봉</th>
										<td><input id="empSal" type="text" class="form-control" name="empSal" disabled></td>
									</tr>
									<tr>
										<th>성별</th>
										<td>
											<select id="empGender" name="empGender" class="form-control" disabled>
									...
									<tr>
										<th>입사일자</th>
										<td><input id="empStartdate" type="date" class="form-control" name="empStartDate" disabled></td>
									</tr>
									<tr>
										<th>퇴사일자</th>
										<td><input id="empEndDate" type="date" class="form-control" name="empEndDate" disabled></td>
									</tr>
									<tr>
										<th>근무상태</th>
										<td>
											<select id="deptState" name="deptState" class="form-control" disabled>
									...
									<tr>
										<th>은행</th>
										<td><input id="empBank" type="text" class="form-control" name="empBank" disabled></td>
									</tr>

									<tr>
										<th>계좌번호</th>
										<td><input id="empBankNum" type="text" class="form-control" name="empBankNum" disabled></td>
									</tr>
								</table>
							</div>
